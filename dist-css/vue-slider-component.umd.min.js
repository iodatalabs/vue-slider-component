              ...
              if (t[r])
                if (-1 !== o.indexOf(r)) t[r] = n({}, t[r], e[r])
                  ...
                  var s = t[r] instanceof Array ? t[r] : [t[r]],
                    c = e[r] instanceof Array ? e[r] : [e[r]]
                  t[r] = s.concat(c)
        ...
        function t() {
          ...
          try {
            ...
            for (var d = 0; d < f.length; d++) {
              ...
              if (u === l && f[d].innerHTML && f[d].innerHTML.trim() === o) return f[d]
            }
            return null
          }
        }
    ...
    fb15: function(t, e, r) {
      ...
      function y(t, e) {
        return (
          ...
          function(r, n) {
            p(e, r, n),
              Object(f['createDecorator'])(function(r, n) {
      ...
      function v(t) {
        return (
          ...
          function(e, r) {
            p(t, e, r),
              Object(f['createDecorator'])(function(e, r) {
                ;(e.props || (e.props = {}))[r] = t
              })(e, r)
          }
        )
      ...
      function D(t, e) {
        return !e || ('object' !== b(e) && 'function' !== typeof e) ? w(t) : e
      }
      function w(t) {
        if (void 0 === t)
      ...
      u([v({ default: 0 })], E.prototype, 'value', void 0),
        u([v()], E.prototype, 'tooltip', void 0),
        u([v()], E.prototype, 'dotStyle', void 0),
        u([v()], E.prototype, 'tooltipStyle', void 0),
        u(
          [
            v({
              type: String,
        ...
        u([v({ type: [String, Function] })], E.prototype, 'tooltipFormatter', void 0),
        u([v({ type: Boolean, default: !1 })], E.prototype, 'focus', void 0),
        u([v({ default: !1 })], E.prototype, 'disabled', void 0),
        (E = u([d.a], E))
      var A = E
      r('556c')
      function V(t) {
      ...
      var z = (function(t) {
        ...
        var e = T(r)
        function r() {
          return _(this, r), e.apply(this, arguments)
        }
        return (
          I(r, [
            {
      ...
      u([v({ required: !0 })], z.prototype, 'mark', void 0),
        u([v(Boolean)], z.prototype, 'hideLabel', void 0),
        u([v()], z.prototype, 'stepStyle', void 0),
        u([v()], z.prototype, 'stepActiveStyle', void 0),
        u([v()], z.prototype, 'labelStyle', void 0),
        u([v()], z.prototype, 'labelActiveStyle', void 0),
        (z = u([d.a], z))
      var $,
        U = z,
        W = function(t) {
      ...
      var mt = ((Q = {}),
        vt(Q, Z.VALUE, 'The type of the "value" is illegal'),
        vt(
          Q,
          Z.INTERVAL,
          'The prop "interval" is invalid, "(max - min)" must be divisible by "interval"',
        ),
        vt(Q, Z.MIN, 'The "value" must be greater than or equal to the "min".'),
        vt(Q, Z.MAX, 'The "value" must be less than or equal to the "max".'),
        vt(
          Q,
          Z.ORDER,
            ...
            yt(t, [
              {
                key: 'setValue',
                value: function(t) {
                  this.setDotsValue(Array.isArray(t) ? st(t) : [t], !0)
                },
              },
              {
                key: 'setDotsValue',
              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  return e.indexOf(Math.min.apply(Math, st(e)))
                },
              },
              {
                key: 'getIndexByValue',
              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  var e = new tt(t).multiply(this.gap).toNumber()
              ...
              },
              {
                ...
                value: function(t) {
                  return t
                    ? new tt(t)
                        .divide(
                          new tt(this.data ? this.data.length - 1 : this.max)
              ...
              },
              {
                ...
                get: function() {
                  ...
                  var e = function(e, r) {
                    ...
                    return rt({ pos: n, value: e, label: e, active: t.isActiveByPos(n) }, r)
                  }
                  return !0 === this.marks
                ...
                get: function() {
                  if (this.process) {
                    ...
                    if (this.dotsPos.length > 1)
                      return [
                        [
                          Math.min.apply(Math, st(this.dotsPos)),
                          Math.max.apply(Math, st(this.dotsPos)),
                        ],
                      ]
                  }
                  return []
                  ...
                  return (
                    (t = this.data
                      ...
                      : new tt(this.max)
                          ...
                          .divide(this.interval)
                          .toNumber()),
                    t - Math.floor(t) !== 0 ? (this.emitError(Z.INTERVAL), 0) : t
                  )
                },
              },
              {
          ...
          return (
            Nt(r, [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  this.isDiff(t, Array.isArray(this.value) ? this.value : [this.value]) &&
                    this.$emit('change', 1 === t.length ? t[0] : At(t), this.focusDotIndex)
                },
              },
              {
                key: 'isDiff',
              ...
              },
              {
                ...
                value: function(t) {
                  ;(this.focusDotIndex = t),
                    this.setScale(),
                    this.states.add(Kt.Drag),
                    this.states.add(Kt.Focus),
              ...
              },
              {
                key: 'dragMove',
                value: function(t) {
                  if (!this.states.has(Kt.Drag)) return !1
                  t.preventDefault()
                  var e = this.getPosByEvent(t)
                  this.isCrossDot(e),
                    this.control.setDotPos(e, this.focusDotIndex),
                ...
                value: function(t) {
                  ...
                  setTimeout(function() {
                    e.lazy && e.syncValueByPos(),
                      ...
                      e.states.delete(Kt.Drag),
                      (e.useKeyboard && !('targetTouches' in t)) || e.states.delete(Kt.Focus),
              ...
              },
              {
                ...
                value: function(t) {
                  if (
                    !this.states.has(Kt.Focus) ||
                    !this.$refs.container ||
                    this.$refs.container.contains(t.target)
                  )
                    return !1
                  this.states.delete(Kt.Focus)
                },
              },
              {
                key: 'clickHandle',
              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  t.disabled || (this.states.add(Kt.Focus), (this.focusDotIndex = e))
                },
              },
              {
                key: 'blur',
              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  ;(this.focusDotIndex = r),
                    ...
                    this.syncValueByPos(),
                    this.useKeyboard && this.states.add(Kt.Focus),
                    setTimeout(function() {
                      e.included && e.isNotSync
                        ? e.control.setValue(e.value)
                        : e.control.syncDotsPos()
              ...
              },
              {
                ...
                value: function(t) {
                  var e = this
                  if (!this.useKeyboard || !this.states.has(Kt.Focus)) return !1
              ...
              },
              {
                key: 'getPosByEvent',
                value: function(t) {
                  return K(t, this.$el, this.isReverse)[this.isHorizontal ? 'x' : 'y'] / this.scale
                },
              },
              {
                key: 'renderSlot',
                                ...
                                return t.renderSlot(
                                  ...
                                  e(
                                    'vue-slider-mark',
                                    {
                                      ...
                                      style: ((o = {}),
                                      Et(o, t.isHorizontal ? 'height' : 'width', '100%'),
                                      Et(o, t.isHorizontal ? 'width' : 'height', t.tailSize),
                                      Et(o, t.mainDirection, ''.concat(r.pos, '%')),
                                      o),
                                      on: {
                  ...
                  return this.control.processArray.map(function(e, r) {
                    ...
                    return {
                      ...
                      style: jt(
                        jt(
                          ((n = {}),
                          Et(n, t.isHorizontal ? 'height' : 'width', '100%'),
                          Et(n, t.isHorizontal ? 'top' : 'left', 0),
                          Et(n, t.mainDirection, ''.concat(i, '%')),
                          Et(n, c, ''.concat(a - i, '%')),
                          Et(n, 'transitionProperty', ''.concat(c, ',').concat(t.mainDirection)),
                          Et(n, 'transitionDuration', ''.concat(t.animateTime, 's')),
                          n),
                          t.processStyle,
                        ),
                        s,
              ...
              },
              {
                ...
                get: function() {
                  ...
                  return (
                    ...
                    jt({ width: ''.concat(n, 'px'), height: ''.concat(o, 'px') }, t)
                  )
                },
              },
              {
                    ...
                    return jt(
                      {
                        ...
                        focus: t.states.has(Kt.Focus) && t.focusDotIndex === r,
                        disabled: t.disabled,
                        style: t.dotStyle,
                      },
              ...
              },
              {
                key: 'animateTime',
                get: function() {
                  return this.states.has(Kt.Drag) ? 0 : this.duration
                },
              },
              {
                key: 'canSort',
      ...
      u([y('change', { default: 0 })], Xt.prototype, 'value', void 0),
        u([v({ type: Boolean, default: !1 })], Xt.prototype, 'silent', void 0),
        u(
          [
            v({
              default: 'ltr',
        ...
        u([v({ type: [Number, String] })], Xt.prototype, 'width', void 0),
        u([v({ type: [Number, String] })], Xt.prototype, 'height', void 0),
        u([v({ default: 14 })], Xt.prototype, 'dotSize', void 0),
        u([v({ default: !1 })], Xt.prototype, 'contained', void 0),
        u([v({ type: Number, default: 0 })], Xt.prototype, 'min', void 0),
        u([v({ type: Number, default: 100 })], Xt.prototype, 'max', void 0),
        u([v({ type: Number, default: 1 })], Xt.prototype, 'interval', void 0),
        u([v({ type: Boolean, default: !1 })], Xt.prototype, 'disabled', void 0),
        u([v({ type: Boolean, default: !0 })], Xt.prototype, 'clickable', void 0),
        u([v({ type: Boolean, default: !1 })], Xt.prototype, 'dragOnClick', void 0),
        u([v({ type: Number, default: 0.5 })], Xt.prototype, 'duration', void 0),
        u([v({ type: [Object, Array] })], Xt.prototype, 'data', void 0),
        u([v({ type: String, default: 'value' })], Xt.prototype, 'dataValue', void 0),
        u([v({ type: String, default: 'label' })], Xt.prototype, 'dataLabel', void 0),
        u([v({ type: Boolean, default: !1 })], Xt.prototype, 'lazy', void 0),
        u(
          [
            v({
              type: String,
        ...
        u([v({ type: [String, Array, Function] })], Xt.prototype, 'tooltipFormatter', void 0),
        u([v({ type: Boolean, default: !0 })], Xt.prototype, 'useKeyboard', void 0),
        u([v(Function)], Xt.prototype, 'keydownHook', void 0),
        u([v({ type: Boolean, default: !0 })], Xt.prototype, 'enableCross', void 0),
        u([v({ type: Boolean, default: !1 })], Xt.prototype, 'fixed', void 0),
        u([v({ type: Boolean, default: !0 })], Xt.prototype, 'order', void 0),
        u([v(Number)], Xt.prototype, 'minRange', void 0),
        u([v(Number)], Xt.prototype, 'maxRange', void 0),
        u(
          [v({ type: [Boolean, Object, Array, Function], default: !1 })],
          Xt.prototype,
          'marks',
          void 0,
        ),
        u([v({ type: [Boolean, Function], default: !0 })], Xt.prototype, 'process', void 0),
        u([v(Boolean)], Xt.prototype, 'included', void 0),
        u([v(Boolean)], Xt.prototype, 'adsorb', void 0),
        u([v(Boolean)], Xt.prototype, 'hideLabel', void 0),
        u([v()], Xt.prototype, 'dotOptions', void 0),
        u([v()], Xt.prototype, 'dotAttrs', void 0),
        u([v()], Xt.prototype, 'railStyle', void 0),
        u([v()], Xt.prototype, 'processStyle', void 0),
        u([v()], Xt.prototype, 'dotStyle', void 0),
        u([v()], Xt.prototype, 'tooltipStyle', void 0),
        u([v()], Xt.prototype, 'stepStyle', void 0),
        u([v()], Xt.prototype, 'stepActiveStyle', void 0),
        u([v()], Xt.prototype, 'labelStyle', void 0),
        u([v()], Xt.prototype, 'labelActiveStyle', void 0),
        u([m('value')], Xt.prototype, 'onValueChanged', null),
        (Xt = u(
          [
            d()({
              data: function() {
              ...
              components: { VueSliderDot: A, VueSliderMark: U },
            }),
          ],
          Xt,
        ))
      var Yt = Xt
      ;(Yt.VueSliderMark = U), (Yt.VueSliderDot = A)
      var Jt = Yt
      e['default'] = Jt
    },
  })['default']
